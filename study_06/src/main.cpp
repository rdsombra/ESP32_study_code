/*
* Study of how to monitor the stack and memory used by the task
* aka High Water Mark.
* by Rafael Sombra
*/
#include <Arduino.h>
...
void vTaskBlink(void *pvParameters) {
    ...
    while (1){
      ...
      /* getting how much free memory is available */
      uxHighWaterMark = uxTaskGetStackHighWaterMark(NULL);
      Serial.println("HWM T1: " + uxHighWaterMark);
    }
}

/* vTask2: prints count value each second*/
void vTask2(void *pvParameters){
  UBaseType_t uxHighWaterMark_t2;
  ...
  while (1){
    ...
    /* return in bytes */
    uxHighWaterMark_t2 = uxTaskGetStackHighWaterMark(NULL);
    //Serial.print("HWM 2");
    //Serial.print(pcTaskGetTaskName(NULL));
    Serial.println("HWM 2: "+ uxHighWaterMark_t2);
